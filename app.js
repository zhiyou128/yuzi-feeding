...
function checkinObservation(ingredientId, day) {
  ...
  state.observations.push({ id: uid('obs'), ingredientId: ingredientId, ingredient: item.name, day: String(day), date: new Date().toISOString().slice(0, 10), slot: 'morning', amount: '', skin: '', digestive: '', mood: '', abnormal: '', note: '', photo: '' });
  saveState(); render();
